...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    sensors = [
        ...
        EltermProxySensor(proxy, "elterm_serverToken", "", None),
        EltermProxySensor(proxy, "elterm_frameType", "", None),
        EltermProxySensor(proxy, "elterm_timeStamp", "", None),
        ...
        EltermProxySensor(proxy, "elterm_buModulCurr", "Current power", "%"),
